program ListaGame.DataSnap.Linha.Comando;
{$APPTYPE CONSOLE}
...
uses
  ...
  Web.WebBroker,
  Datasnap.DSSession,
  ListaGame.DataSnap.Constante in 'ListaGame.DataSnap.Constante.pas',
  ListaGame.DataSnap.Controlador.Exemplo in 'ListaGame.DataSnap.Controlador.Exemplo.pas',
  ListaGame.DataSnap.ModuloWEB in 'ListaGame.DataSnap.ModuloWEB.pas' {ModuloWEBDataSnap: TWebModule},
  ListaGame.Game in '..\..\dominio\game\ListaGame.Game.pas',
  ListaGame.Game.Dado in '..\..\dominio\game\ListaGame.Game.Dado.pas';
...
begin
  ...
  if WebRequestHandler <> nil then
    WebRequestHandler.WebModuleClass := ModuloWEBDataSnapClass;
    RunServer(8080);
  except
    on E: Exception do
